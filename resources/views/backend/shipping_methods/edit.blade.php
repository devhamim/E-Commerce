                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Location Name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $ShippingMethod->name }}">
                                    @error('name')
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" placeholder="Price" class="form-control"  name="price" value="{{ $ShippingMethod->price }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
