                ...
                <div class="card-body">
                    <form action="{{ route('variation.update', $variation->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    <label for="product_name" class="form-label">Variation Name</label>
                                    <input type="text" placeholder="Entire Name" class="form-control" name="variation_name" value="{{ $variation->variation_name }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
