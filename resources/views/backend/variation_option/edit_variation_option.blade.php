    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('variation_option.update', $request->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Entire Name" class="form-control" name="option_name" value="{{ $request->option_name }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
