            ...
            <div class="row">
                                ...
                                <div class="container">
                                    <div class="slider-1-height-3 slider-animated-1">
                                        <div class="hero-slider-content-2">
                                            ...
                                            <h2 class="animated fw-900">{{ $banner->category->category_name }}</h2>
                                            <h1 class="animated fw-900 text-brand">{{ $banner->banner_title }}</h1>
                                            <p class="animated">{{ $banner->banner_description }}</p>
                                            <a class="animated btn btn-brush btn-brush-3" href="{{ $banner->link }}"> Shop Now </a>
                                        </div>
                ...
                <div class="col-lg-3 d-md-none d-lg-block">
                    <div class="banner-img banner-1 wow fadeIn  animated home-3">
                        <img class="border-radius-10" src="{{ asset('frontend') }}/imgs/banner/banner-5.jpg" alt="">
                    ...
                    <div class="banner-img banner-2 wow fadeIn  animated mb-0">
                        <img class="border-radius-10" src="{{ asset('frontend') }}/imgs/banner/banner-7.jpg" alt="">
                        <div class="banner-text">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href=""><img src="{{ asset('files/category') }}/{{ $category->category_image }}" alt=""></a>
                        </figure>
            ...
            <div class="tab-header">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="nav-tab-three" data-bs-toggle="tab" data-bs-target="#tab-three" type="button" role="tab" aria-controls="tab-three" aria-selected="false">New added</button>
                    </li>
                </ul>
            ...
            <div class="tab-content wow fadeIn animated" id="myTabContent">
                <div class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                    <div class="row product-grid-4">
                        @foreach ($productitems->take(8) as $product)
                            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('product.details', $product->SKU) }}">
                                                <img class="default-img" src="{{ asset('files/product') }}/{{ $product->rel_to_product->product_image }}" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop-grid-right.html">{{ $product->rel_to_product->category->category_name }}</a>
                                        </div>
                                        <h2><a href="{{ route('product.details', $product->SKU) }}">{{ $product->rel_to_product->product_name }}</a></h2>
                                        ...
                                        <div class="product-price">
                                            <span>{{ $product->rel_to_product->sale_price }}</span>
