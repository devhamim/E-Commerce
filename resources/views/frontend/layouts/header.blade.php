...
<div class="modal fade custom-modal" id="onloadModal" tabindex="-1" aria-labelledby="onloadModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="deal" style="background-image: url('{{ asset('frontend') }}/imgs/banner/menu-banner-7.png')">
                    <div class="deal-top">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="social-icons single-share">
                            <ul class="text-grey-5 d-inline-block">
                                ...
                                <li class="social-facebook"><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                <li class="social-twitter"> <a href="#"><img src="{{ asset('frontend') }}/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                <li class="social-instagram"><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
                                <li class="social-linkedin"><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/icons/icon-pinterest.svg" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara" src="{{ asset('frontend') }}/imgs/shop/thumbnail-3.jpg"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara" src="{{ asset('frontend') }}/imgs/shop/thumbnail-2.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                    ...
                                    <ul class="mega-menu">
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="shop-product-right.html"><img src="{{ asset('frontend') }}/imgs/banner/menu-banner.jpg" alt="Evara"></a>
                        ...
                        <div class="header-action-icon-2">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Evara" src="{{ asset('frontend') }}/imgs/shop/thumbnail-4.jpg"></a>
                                        </div>
                                        <div class="shopping-cart-title">
