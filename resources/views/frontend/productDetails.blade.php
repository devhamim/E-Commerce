                        ...
                        <div class="row mb-50">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info">
                                    <h2 class="title-detail">{{ $productitems->first()->rel_to_product->product_name }}</h2>
                                    <div class="product-detail-rating">
                                        <div class="pro-details-brand">
                                            <span> Category: <a href="shop-grid-right.html">{{ $productitems->first()->rel_to_product->category->category_name }}</a></span>
                                        </div>
